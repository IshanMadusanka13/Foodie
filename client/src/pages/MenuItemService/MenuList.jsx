...
//         try {
//             await api.updateMenuItem(updatedItem._id, updatedItem);

//             const updateItemList = (list) =>
//                 list.map((item) => (item._id === updatedItem._id ? updatedItem : item));

//             setMenuItems((prev) => updateItemList(prev));
//             setFilteredItems((prev) => updateItemList(prev));
//             setEditingItem(null);
...
//                 onSave={() => handleUpdate(editingItem)}
